...
main(int argc,char *argv[])
{
  ...
  19:	e8 d4 03 00 00       	call   3f2 <shmget>
	char *s = shmget("151");
  1e:	c7 04 24 d0 07 00 00 	movl   $0x7d0,(%esp)
	//printf(1,"key %d\n",key);
	int pid ;
	//pid = fork();
	//sleep(1);
  ...
  25:	89 c3                	mov    %eax,%ebx
	char *s = shmget("151");
  27:	e8 c6 03 00 00       	call   3f2 <shmget>
  2c:	89 c6                	mov    %eax,%esi
	pid = fork();
  2e:	e8 17 03 00 00       	call   34a <fork>
  33:	89 c7                	mov    %eax,%edi
	sleep(1);
  35:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  3c:	e8 a1 03 00 00       	call   3e2 <sleep>
	if (pid)
  41:	83 c4 10             	add    $0x10,%esp
  44:	85 ff                	test   %edi,%edi
  46:	74 7c                	je     c4 <main+0xc4>
	{	
		p[0] = 'A';
  48:	c6 03 41             	movb   $0x41,(%ebx)
		p[1] = 'D';
  4b:	c6 43 01 44          	movb   $0x44,0x1(%ebx)
		p[2] = 'C';
  4f:	c6 43 02 43          	movb   $0x43,0x2(%ebx)
		s[0] = '4';
  53:	c6 06 34             	movb   $0x34,(%esi)
		printf(1,"%c Parent %c %c %c %x\n",s[0],p[0],p[1],p[2],(unsigned int) p);
  56:	52                   	push   %edx
  57:	53                   	push   %ebx
  58:	0f be 43 02          	movsbl 0x2(%ebx),%eax
  5c:	50                   	push   %eax
  5d:	0f be 43 01          	movsbl 0x1(%ebx),%eax
  61:	50                   	push   %eax
  62:	0f be 03             	movsbl (%ebx),%eax
  65:	50                   	push   %eax
  66:	6a 34                	push   $0x34
  68:	68 d4 07 00 00       	push   $0x7d4
  6d:	6a 01                	push   $0x1
  6f:	e8 3c 04 00 00       	call   4b0 <printf>
		wait();
  74:	83 c4 20             	add    $0x20,%esp
  77:	e8 de 02 00 00       	call   35a <wait>
		printf(1,"ParentAfter %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
  7c:	51                   	push   %ecx
  7d:	51                   	push   %ecx
  7e:	53                   	push   %ebx
  7f:	0f be 43 02          	movsbl 0x2(%ebx),%eax
  83:	50                   	push   %eax
  84:	0f be 43 01          	movsbl 0x1(%ebx),%eax
  88:	50                   	push   %eax
  89:	0f be 03             	movsbl (%ebx),%eax
  8c:	50                   	push   %eax
  8d:	68 eb 07 00 00       	push   $0x7eb
  92:	6a 01                	push   $0x1
  ...
  99:	83 c4 1c             	add    $0x1c,%esp
		...
		printf(1,"ParentAfter %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
		p[1] = 'K';
  9c:	c6 43 01 4b          	movb   $0x4b,0x1(%ebx)
		printf(1,"%c ParentAfterK %c %c %c %x\n",s[0],p[0],p[1],p[2],(unsigned int) p);
  a0:	53                   	push   %ebx
  a1:	0f be 43 02          	movsbl 0x2(%ebx),%eax
  a5:	50                   	push   %eax
  a6:	6a 4b                	push   $0x4b
  a8:	0f be 03             	movsbl (%ebx),%eax
  ab:	50                   	push   %eax
  ac:	0f be 06             	movsbl (%esi),%eax
  af:	50                   	push   %eax
  ...
  c4:	50                   	push   %eax
  c5:	53                   	push   %ebx
  c6:	0f be 43 02          	movsbl 0x2(%ebx),%eax
  ca:	50                   	push   %eax
  cb:	0f be 43 01          	movsbl 0x1(%ebx),%eax
  cf:	50                   	push   %eax
  d0:	0f be 03             	movsbl (%ebx),%eax
  d3:	50                   	push   %eax
  d4:	0f be 06             	movsbl (%esi),%eax
  d7:	50                   	push   %eax
  d8:	68 38 08 00 00       	push   $0x838
  dd:	6a 01                	push   $0x1
  df:	e8 cc 03 00 00       	call   4b0 <printf>
		p[1] = 'J';
		s[0] = 'Y';
		printf(1,"%c Child %c %c %c %x\n",s[0],p[0],p[1],p[2],(unsigned int) p);
  e4:	83 c4 1c             	add    $0x1c,%esp
		printf(1,"%c ParentAfterK %c %c %c %x\n",s[0],p[0],p[1],p[2],(unsigned int) p);
	}
	else
	{
		printf(1,"%c Child initially %c %c %c %x\n",s[0],p[0],p[1],p[2],(unsigned int) p);
		p[1] = 'J';
  e7:	c6 43 01 4a          	movb   $0x4a,0x1(%ebx)
		s[0] = 'Y';
  eb:	c6 06 59             	movb   $0x59,(%esi)
		printf(1,"%c Child %c %c %c %x\n",s[0],p[0],p[1],p[2],(unsigned int) p);
  ee:	53                   	push   %ebx
  ef:	0f be 43 02          	movsbl 0x2(%ebx),%eax
  f3:	50                   	push   %eax
  f4:	0f be 43 01          	movsbl 0x1(%ebx),%eax
  f8:	50                   	push   %eax
  f9:	0f be 03             	movsbl (%ebx),%eax
  fc:	50                   	push   %eax
  fd:	6a 59                	push   $0x59
  ff:	68 21 08 00 00       	push   $0x821
 104:	6a 01                	push   $0x1
 106:	e8 a5 03 00 00       	call   4b0 <printf>
 10b:	83 c4 20             	add    $0x20,%esp
 10e:	eb af                	jmp    bf <main+0xbf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44f:	f7 f6                	div    %esi
 451:	0f b6 92 60 08 00 00 	movzbl 0x860(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5c8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5cb:	b8 58 08 00 00       	mov    $0x858,%eax
