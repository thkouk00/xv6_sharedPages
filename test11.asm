...
main(int argc,char *argv[])
{
  ...
  10:	83 ec 18             	sub    $0x18,%esp
	...
	char *p = shmget("51");
  13:	68 b0 07 00 00       	push   $0x7b0
  18:	e8 b5 03 00 00       	call   3d2 <shmget>
  1d:	89 c3                	mov    %eax,%ebx
	//char *s = shmget("51");
	pid = fork();
  1f:	e8 06 03 00 00       	call   32a <fork>
  24:	89 c6                	mov    %eax,%esi
	sleep(1);
  26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  2d:	e8 90 03 00 00       	call   3c2 <sleep>
	if (pid)
  32:	83 c4 10             	add    $0x10,%esp
  35:	85 f6                	test   %esi,%esi
  37:	74 6c                	je     a5 <main+0xa5>
	{	
		p[0] = 'A';
  39:	c6 03 41             	movb   $0x41,(%ebx)
		p[1] = 'D';
  3c:	c6 43 01 44          	movb   $0x44,0x1(%ebx)
		p[2] = 'C';
  40:	c6 43 02 43          	movb   $0x43,0x2(%ebx)
		//s[0] = '4';
  ...
  49:	6a 44                	push   $0x44
  4b:	6a 41                	push   $0x41
  4d:	68 b3 07 00 00       	push   $0x7b3
  52:	6a 01                	push   $0x1
  54:	e8 37 04 00 00       	call   490 <printf>
		wait();
  59:	83 c4 20             	add    $0x20,%esp
  5c:	e8 d9 02 00 00       	call   33a <wait>
		printf(1,"ParentAfter %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
  61:	51                   	push   %ecx
  62:	51                   	push   %ecx
  63:	53                   	push   %ebx
  64:	0f be 43 02          	movsbl 0x2(%ebx),%eax
  68:	50                   	push   %eax
  69:	0f be 43 01          	movsbl 0x1(%ebx),%eax
  6d:	50                   	push   %eax
  6e:	0f be 03             	movsbl (%ebx),%eax
  71:	50                   	push   %eax
  72:	68 c7 07 00 00       	push   $0x7c7
  77:	6a 01                	push   $0x1
  79:	e8 12 04 00 00       	call   490 <printf>
		p[1] = 'K';
		printf(1,"ParentAfterK %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
  7e:	83 c4 18             	add    $0x18,%esp
		p[2] = 'C';
		//s[0] = '4';
		printf(1,"Parent %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
		wait();
		printf(1,"ParentAfter %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
		p[1] = 'K';
  81:	c6 43 01 4b          	movb   $0x4b,0x1(%ebx)
		printf(1,"ParentAfterK %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
  85:	53                   	push   %ebx
  86:	0f be 43 02          	movsbl 0x2(%ebx),%eax
  8a:	50                   	push   %eax
  8b:	6a 4b                	push   $0x4b
  8d:	0f be 03             	movsbl (%ebx),%eax
  90:	50                   	push   %eax
  91:	68 e0 07 00 00       	push   $0x7e0
  96:	6a 01                	push   $0x1
  ...
  a6:	50                   	push   %eax
  a7:	53                   	push   %ebx
  a8:	0f be 43 02          	movsbl 0x2(%ebx),%eax
  ac:	50                   	push   %eax
  ad:	0f be 43 01          	movsbl 0x1(%ebx),%eax
  b1:	50                   	push   %eax
  ...
  c2:	83 c4 18             	add    $0x18,%esp
	...
	else
	{
		printf(1,"Child initially %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
		p[1] = 'J';
  c5:	c6 43 01 4a          	movb   $0x4a,0x1(%ebx)
		printf(1,"Child %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
  c9:	53                   	push   %ebx
  ca:	0f be 43 02          	movsbl 0x2(%ebx),%eax
  ce:	50                   	push   %eax
  cf:	6a 4a                	push   $0x4a
  d1:	0f be 03             	movsbl (%ebx),%eax
  d4:	50                   	push   %eax
  d5:	68 17 08 00 00       	push   $0x817
  da:	6a 01                	push   $0x1
  dc:	e8 af 03 00 00       	call   490 <printf>
  e1:	83 c4 20             	add    $0x20,%esp
  e4:	eb ba                	jmp    a0 <main+0xa0>
  e6:	66 90                	xchg   %ax,%ax
  e8:	66 90                	xchg   %ax,%ax
  ea:	66 90                	xchg   %ax,%ax
  ec:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42f:	f7 f6                	div    %esi
 431:	0f b6 92 34 08 00 00 	movzbl 0x834(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 2a 08 00 00       	mov    $0x82a,%eax
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 d4 0a 00 00       	mov    %eax,0xad4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 d4 0a 00 00 d8 	movl   $0xad8,0xad4
 78d:	0a 00 00 
 790:	c7 05 d8 0a 00 00 d8 	movl   $0xad8,0xad8
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 d8 0a 00 00       	mov    $0xad8,%eax
