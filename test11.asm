...
main(int argc,char *argv[])
{
  ...
  23:	89 c3                	mov    %eax,%ebx
	...
	char *p;
	p = h+sizeof(writers);
  25:	8d 70 04             	lea    0x4(%eax),%esi
	sem_init(writers,2);
  28:	e8 d5 03 00 00       	call   402 <sem_init>
	pid = fork();
  2d:	e8 18 03 00 00       	call   34a <fork>
  32:	89 c7                	mov    %eax,%edi
	sleep(1);
  34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  3b:	e8 a2 03 00 00       	call   3e2 <sleep>
	if (pid)
  40:	83 c4 10             	add    $0x10,%esp
  43:	85 ff                	test   %edi,%edi
  45:	74 7a                	je     c1 <main+0xc1>
	{	
		//wait();
		sem_down(writers);
  47:	83 ec 0c             	sub    $0xc,%esp
  4a:	53                   	push   %ebx
  4b:	e8 c2 03 00 00       	call   412 <sem_down>
		p[0] = 'A';
  50:	c6 43 04 41          	movb   $0x41,0x4(%ebx)
		p[1] = 'D';
  54:	c6 43 05 44          	movb   $0x44,0x5(%ebx)
		p[2] = 'C';
  58:	c6 43 06 43          	movb   $0x43,0x6(%ebx)
		//sem_up(writers);
		//wait();
		//sem_down(writers);
  ...
  61:	6a 44                	push   $0x44
  63:	6a 41                	push   $0x41
  65:	68 e3 07 00 00       	push   $0x7e3
  6a:	6a 01                	push   $0x1
  6c:	e8 4f 04 00 00       	call   4c0 <printf>
		printf(1,"ParentAfter %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
  71:	83 c4 18             	add    $0x18,%esp
  74:	56                   	push   %esi
  75:	0f be 43 06          	movsbl 0x6(%ebx),%eax
  79:	50                   	push   %eax
  7a:	0f be 43 05          	movsbl 0x5(%ebx),%eax
  7e:	50                   	push   %eax
  7f:	0f be 43 04          	movsbl 0x4(%ebx),%eax
  83:	50                   	push   %eax
  84:	68 f7 07 00 00       	push   $0x7f7
  89:	6a 01                	push   $0x1
  ...
  90:	83 c4 18             	add    $0x18,%esp
		...
		//sem_down(writers);
		p[1] = 'K';
  93:	c6 43 05 4b          	movb   $0x4b,0x5(%ebx)
		printf(1,"ParentAfterK %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
  97:	56                   	push   %esi
  98:	0f be 43 06          	movsbl 0x6(%ebx),%eax
  9c:	50                   	push   %eax
  9d:	6a 4b                	push   $0x4b
  9f:	0f be 43 04          	movsbl 0x4(%ebx),%eax
  a3:	50                   	push   %eax
  a4:	68 10 08 00 00       	push   $0x810
	else
	{
		sem_down(writers);
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 10 04 00 00       	call   4c0 <printf>
		sem_up(writers);
  b0:	83 c4 14             	add    $0x14,%esp
  b3:	53                   	push   %ebx
  b4:	e8 51 03 00 00       	call   40a <sem_up>
  ...
  c4:	53                   	push   %ebx
  c5:	e8 48 03 00 00       	call   412 <sem_down>
		printf(1,"Child initially %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
  ca:	58                   	pop    %eax
  cb:	5a                   	pop    %edx
  cc:	56                   	push   %esi
  cd:	0f be 43 06          	movsbl 0x6(%ebx),%eax
  d1:	50                   	push   %eax
  d2:	0f be 43 05          	movsbl 0x5(%ebx),%eax
  d6:	50                   	push   %eax
  d7:	0f be 43 04          	movsbl 0x4(%ebx),%eax
  db:	50                   	push   %eax
  dc:	68 2a 08 00 00       	push   $0x82a
  e1:	6a 01                	push   $0x1
  ...
  e8:	83 c4 18             	add    $0x18,%esp
	...
	else
	{
		...
		printf(1,"Child initially %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
		p[1] = 'J';
  eb:	c6 43 05 4a          	movb   $0x4a,0x5(%ebx)
		printf(1,"Child %c %c %c %x\n",p[0],p[1],p[2],(unsigned int) p);
  ef:	56                   	push   %esi
  f0:	0f be 43 06          	movsbl 0x6(%ebx),%eax
  f4:	50                   	push   %eax
  f5:	6a 4a                	push   $0x4a
  f7:	0f be 43 04          	movsbl 0x4(%ebx),%eax
  fb:	50                   	push   %eax
  fc:	68 47 08 00 00       	push   $0x847
 101:	eb a6                	jmp    a9 <main+0xa9>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45f:	f7 f6                	div    %esi
 461:	0f b6 92 64 08 00 00 	movzbl 0x864(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5db:	b8 5a 08 00 00       	mov    $0x85a,%eax
...
free(void *ap)
{
 ...
 6b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6b9:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 6be:	5b                   	pop    %ebx
 6bf:	5e                   	pop    %esi
 6c0:	5f                   	pop    %edi
 ...
 6da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6dd:	a3 08 0b 00 00       	mov    %eax,0xb08
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 7b4:	eb e9                	jmp    79f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 08 0b 00 00 0c 	movl   $0xb0c,0xb08
 7bd:	0b 00 00 
 7c0:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	b8 0c 0b 00 00       	mov    $0xb0c,%eax
 7cf:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 7d6:	00 00 00 
