...
main(int argc,char *argv[])
{
  ...
  10:	83 ec 18             	sub    $0x18,%esp
	...
	sleep(1);
  13:	6a 01                	push   $0x1
  15:	e8 68 03 00 00       	call   382 <sleep>
	char *h = shmget("325");
  1a:	c7 04 24 80 07 00 00 	movl   $0x780,(%esp)
  21:	e8 6c 03 00 00       	call   392 <shmget>
	char *p ;
	writers = (sem_t *)h;
	sem_init(writers, 1);
  26:	5a                   	pop    %edx
...
main(int argc,char *argv[])
{
  ...
  2d:	8d 73 04             	lea    0x4(%ebx),%esi
	...
	writers = (sem_t *)h;
	sem_init(writers, 1);
  30:	e8 6d 03 00 00       	call   3a2 <sem_init>
	p = h+sizeof(writers);
	pid = fork();
  35:	e8 b0 02 00 00       	call   2ea <fork>
	if (pid)
  ...
  44:	53                   	push   %ebx
  45:	e8 68 03 00 00       	call   3b2 <sem_down>
		*p = 'I';
  4a:	c6 43 04 49          	movb   $0x49,0x4(%ebx)
		printf(1,"Parent %c %x\n",*p,(unsigned int) p);
  4e:	56                   	push   %esi
  4f:	6a 49                	push   $0x49
  51:	68 84 07 00 00       	push   $0x784
  56:	6a 01                	push   $0x1
  58:	e8 03 04 00 00       	call   460 <printf>
		//wait();
		printf(1,"Parent After %c %x\n",*p,(unsigned int) p);
  5d:	83 c4 20             	add    $0x20,%esp
  60:	56                   	push   %esi
  61:	0f be 43 04          	movsbl 0x4(%ebx),%eax
  65:	50                   	push   %eax
  66:	68 92 07 00 00       	push   $0x792
	else
	{
		sem_down(writers);
		printf(1,"Child %c %x\n",*p,(unsigned int) p);
  ...
  75:	e8 30 03 00 00       	call   3aa <sem_up>
  ...
  85:	53                   	push   %ebx
  86:	e8 27 03 00 00       	call   3b2 <sem_down>
		printf(1,"Child %c %x\n",*p,(unsigned int) p);
  8b:	56                   	push   %esi
  8c:	0f be 43 04          	movsbl 0x4(%ebx),%eax
  90:	50                   	push   %eax
  91:	68 a6 07 00 00       	push   $0x7a6
  96:	6a 01                	push   $0x1
  98:	e8 c3 03 00 00       	call   460 <printf>
		*p = '1';
		printf(1,"Child After %c %x\n",*p,(unsigned int) p);
  9d:	83 c4 20             	add    $0x20,%esp
	...
	else
	{
		...
		printf(1,"Child %c %x\n",*p,(unsigned int) p);
		*p = '1';
  a0:	c6 43 04 31          	movb   $0x31,0x4(%ebx)
		printf(1,"Child After %c %x\n",*p,(unsigned int) p);
  a4:	56                   	push   %esi
  a5:	6a 31                	push   $0x31
  a7:	68 b3 07 00 00       	push   $0x7b3
  ac:	eb bd                	jmp    6b <main+0x6b>
  ae:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 c6 07 00 00       	mov    $0x7c6,%eax
...
free(void *ap)
{
 ...
 67a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 67d:	a3 70 0a 00 00       	mov    %eax,0xa70
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 73f:	89 15 70 0a 00 00    	mov    %edx,0xa70
      return (void*)(p + 1);
 ...
 754:	eb e9                	jmp    73f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 75d:	0a 00 00 
 760:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 767:	0a 00 00 
    base.s.size = 0;
 76a:	b8 74 0a 00 00       	mov    $0xa74,%eax
 76f:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 776:	00 00 00 
