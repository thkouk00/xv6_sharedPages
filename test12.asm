...
main(int argc,char *argv[])
{
  ...
  10:	83 ec 0c             	sub    $0xc,%esp
	int pid;
	pid = fork();
  13:	e8 e2 02 00 00       	call   2fa <fork>
	sleep(1);
...
main(int argc,char *argv[])
{
  ...
  1f:	e8 6e 03 00 00       	call   392 <sleep>
	char *p = shmget("325");
  24:	c7 04 24 80 07 00 00 	movl   $0x780,(%esp)
  2b:	e8 72 03 00 00       	call   3a2 <shmget>
	//*p = 'G';
	if (pid)
...
main(int argc,char *argv[])
{
  ...
  35:	89 c3                	mov    %eax,%ebx
	//*p = 'G';
	if (pid)
  37:	74 30                	je     69 <main+0x69>
	{
		*p = 'I';
  39:	c6 00 49             	movb   $0x49,(%eax)
		printf(1,"Parent %c %x\n",*p,(unsigned int) p);
  3c:	50                   	push   %eax
  3d:	6a 49                	push   $0x49
  3f:	68 84 07 00 00       	push   $0x784
  44:	6a 01                	push   $0x1
  46:	e8 15 04 00 00       	call   460 <printf>
		wait();
  4b:	e8 ba 02 00 00       	call   30a <wait>
		printf(1,"Parent After %c %x\n",*p,(unsigned int) p);
  50:	53                   	push   %ebx
  51:	0f be 03             	movsbl (%ebx),%eax
  54:	50                   	push   %eax
  55:	68 92 07 00 00       	push   $0x792
  5a:	6a 01                	push   $0x1
  ...
  61:	83 c4 20             	add    $0x20,%esp
	...
	exit();	
  64:	e8 99 02 00 00       	call   302 <exit>
		wait();
		printf(1,"Parent After %c %x\n",*p,(unsigned int) p);
	}
	else
	{
		printf(1,"Child %c %x\n",*p,(unsigned int) p);
  69:	50                   	push   %eax
  6a:	0f be 00             	movsbl (%eax),%eax
  6d:	50                   	push   %eax
  6e:	68 a6 07 00 00       	push   $0x7a6
  73:	6a 01                	push   $0x1
  75:	e8 e6 03 00 00       	call   460 <printf>
		*p = '1';
  7a:	c6 03 31             	movb   $0x31,(%ebx)
		printf(1,"Child After %c %x\n",*p,(unsigned int) p);
  7d:	53                   	push   %ebx
  7e:	6a 31                	push   $0x31
  80:	68 b3 07 00 00       	push   $0x7b3
  85:	6a 01                	push   $0x1
  87:	e8 d4 03 00 00       	call   460 <printf>
		char *k = shmget("12");
  8c:	83 c4 14             	add    $0x14,%esp
  8f:	68 c6 07 00 00       	push   $0x7c6
  94:	e8 09 03 00 00       	call   3a2 <shmget>
		*k = 'G';
  99:	c6 00 47             	movb   $0x47,(%eax)
		printf(1,"Child k page %c %x\n",*k,(unsigned int) k);
  9c:	50                   	push   %eax
  9d:	6a 47                	push   $0x47
  9f:	68 c9 07 00 00       	push   $0x7c9
  a4:	6a 01                	push   $0x1
  a6:	e8 b5 03 00 00       	call   460 <printf>
		shmrem("12");
  ab:	83 c4 14             	add    $0x14,%esp
  ae:	68 c6 07 00 00       	push   $0x7c6
  b3:	e8 f2 02 00 00       	call   3aa <shmrem>
  b8:	83 c4 10             	add    $0x10,%esp
  bb:	eb a7                	jmp    64 <main+0x64>
  bd:	66 90                	xchg   %ax,%ax
  bf:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ff:	f7 f6                	div    %esi
 401:	0f b6 92 e4 07 00 00 	movzbl 0x7e4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 dd 07 00 00       	mov    $0x7dd,%eax
