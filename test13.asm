...
main(int argc,char *argv[])
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
	...
	//printf(1,"key %d\n",key);
	char *p = shmget("51");
  11:	68 20 07 00 00       	push   $0x720
  16:	e8 27 03 00 00       	call   342 <shmget>
	*p = 'a';
  1b:	c6 00 61             	movb   $0x61,(%eax)
	printf(1,"%c %x\n",*p,(unsigned int) p);
  1e:	50                   	push   %eax
  1f:	6a 61                	push   $0x61
  21:	68 23 07 00 00       	push   $0x723
  26:	6a 01                	push   $0x1
  28:	e8 d3 03 00 00       	call   400 <printf>
	char *pp = shmget("9876543321");
  2d:	83 c4 14             	add    $0x14,%esp
  30:	68 2a 07 00 00       	push   $0x72a
  35:	e8 08 03 00 00       	call   342 <shmget>
	*pp = 'b';
  3a:	c6 00 62             	movb   $0x62,(%eax)
	printf(1,"%c %x\n",*pp,(unsigned int) pp);
  3d:	50                   	push   %eax
  3e:	6a 62                	push   $0x62
  40:	68 23 07 00 00       	push   $0x723
  45:	6a 01                	push   $0x1
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 35 07 00 00       	mov    $0x735,%eax
