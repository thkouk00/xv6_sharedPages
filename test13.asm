...
main(int argc,char *argv[])
{
  ...
  2f:	6a 01                	push   $0x1
  31:	53                   	push   %ebx
  32:	e8 ab 03 00 00       	call   3e2 <sem_init>
	int *buffer;
  ...
  37:	83 c4 0c             	add    $0xc,%esp
	...
	buffer = (int *)(p+sizeof(writers));
	buffer[0] = 1;
  3a:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
	printf(1,"buf0 %d\n",buffer[0]);
  41:	6a 01                	push   $0x1
  43:	68 c9 07 00 00       	push   $0x7c9
  48:	6a 01                	push   $0x1
  4a:	e8 51 04 00 00       	call   4a0 <printf>
	int pid;
	pid = fork();
  4f:	e8 d6 02 00 00       	call   32a <fork>
	if (pid)
  54:	83 c4 10             	add    $0x10,%esp
  57:	85 c0                	test   %eax,%eax
  59:	74 54                	je     af <main+0xaf>
	{
		//wait();
		sem_down(writers);
  ...
  60:	53                   	push   %ebx
  61:	e8 8c 03 00 00       	call   3f2 <sem_down>
		printf(1,"fork %d\n",pid);
  66:	83 c4 0c             	add    $0xc,%esp
  69:	56                   	push   %esi
  6a:	68 d2 07 00 00       	push   $0x7d2
  6f:	6a 01                	push   $0x1
  71:	e8 2a 04 00 00       	call   4a0 <printf>
		printf(1,"Parent before writer\n");
  76:	59                   	pop    %ecx
  77:	5e                   	pop    %esi
  78:	68 db 07 00 00       	push   $0x7db
  7d:	6a 01                	push   $0x1
  ...
  8a:	05 e8 03 00 00       	add    $0x3e8,%eax
  8f:	89 43 04             	mov    %eax,0x4(%ebx)
  92:	50                   	push   %eax
  93:	68 f1 07 00 00       	push   $0x7f1
  ...
  a2:	e8 43 03 00 00       	call   3ea <sem_up>
  ...
  b2:	53                   	push   %ebx
  b3:	e8 3a 03 00 00       	call   3f2 <sem_down>
		printf(1,"fork %d\n",pid);
  b8:	83 c4 0c             	add    $0xc,%esp
  bb:	6a 00                	push   $0x0
  bd:	68 d2 07 00 00       	push   $0x7d2
  c2:	6a 01                	push   $0x1
  c4:	e8 d7 03 00 00       	call   4a0 <printf>
		printf(1,"Child before writer\n");
  c9:	58                   	pop    %eax
  ca:	5a                   	pop    %edx
  cb:	68 06 08 00 00       	push   $0x806
  d0:	6a 01                	push   $0x1
  d2:	e8 c9 03 00 00       	call   4a0 <printf>
  d7:	8b 43 04             	mov    0x4(%ebx),%eax
		for (int i=0;i<1000;i++)
		{
			buffer[0]--;
		}
  ...
  dd:	2d e8 03 00 00       	sub    $0x3e8,%eax
  e2:	89 43 04             	mov    %eax,0x4(%ebx)
  e5:	50                   	push   %eax
  e6:	68 1b 08 00 00       	push   $0x81b
  eb:	eb ab                	jmp    98 <main+0x98>
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 38 08 00 00 	movzbl 0x838(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 2f 08 00 00       	mov    $0x82f,%eax
